...
public class UsmeniIspit extends Ispit {
	private String vrstaIspita;
	private String ucionica;
	
	public UsmeniIspit(String predmet, String nastavnik, String datumVrijemeIspita, ArrayList<Student> studenti, String ucionica) {
		super(predmet, nastavnik, datumVrijemeIspita, studenti);
		this.setVrstaIspita(getVrsteIspita()[1]);
